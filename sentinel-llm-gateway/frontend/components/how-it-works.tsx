          ...
          {steps.map((step) => (
            ...
            >
              ...
              <motion.div
                ...
                className="inline-block w-12 h-12 rounded-full bg-primary/20 border border-primary/60 flex items-center justify-center text-lg font-bold text-primary mb-4"
              >
                {step.number}
              </motion.div>
